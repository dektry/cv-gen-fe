...
export const deleteTechAssessmentAction = `${appStoreName}/delete-tech-assessment`;
export const getTechAssessmentsComparisonAction = `${appStoreName}/get-tech-assessments-comparison`;
