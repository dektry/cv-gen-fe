export const appStoreName = 'softskills';

export const loadSoftskillInterviewResultAction = `${appStoreName}/interviewResult`;
export const completeSoftSkillInterviewResultAction = `${appStoreName}/interviewComplete`;
