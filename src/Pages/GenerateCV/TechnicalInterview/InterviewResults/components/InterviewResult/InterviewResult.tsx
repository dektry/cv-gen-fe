  ...
  return (
    <section className={classes.interviewResult}>
      ...
      <div className={classes.infoFields}>
        <InterviewInfoCard isEdited={isEdited} cardOptions="position" positions={allPositions} />
        <InterviewInfoCard isEdited={isEdited} cardOptions="level" levels={allLevels} />
      ...
      <div className={classes.bottomContainer}>
        <div>
          ...
          <Radio.Group options={radioOptions} disabled={!isEdited} onChange={handleRadioChange} value={isOffered} />
        </div>
        <Input.TextArea
          id="comment"
          rows={2}
