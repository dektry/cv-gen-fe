...
export const SelectPositions = (props: IProps) => {
  ...
  const editButtonText = fieldsDisabled ? SOFT_SKILL_INTERVIEW.START_EDIT : SOFT_SKILL_INTERVIEW.DISABLE_EDIT;
  return (
    <div className={classes.selectContainer}>
      ...
      {successfullySaved && (
        <Button className={classes.editButton} onClick={handleClick} disabled={!successfullySaved}>
          {editButtonText}
        </Button>
      )}
    </div>
