...
import { CandidatesSelectFilter } from 'pages/SelectCandidateType/utils/constants';
...
export const SelectCandidateType: FC<SelectCandidateProps> = ({
  ...
  return (
    ...
    >
      <Option value={CandidatesSelectFilter.ALL}>
        {CandidatesSelectFilter.ALL}
      </Option>
      <Option value={CandidatesSelectFilter.TECH}>
        {CandidatesSelectFilter.TECH}
      </Option>
      <Option value={CandidatesSelectFilter.SOFT}>
        {CandidatesSelectFilter.SOFT}
      </Option>
    </Select>
  );
};
